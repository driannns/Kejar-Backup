            ...
            <div class="w-2/5 h-full py-14 pl-20 pr-44 text-white">
                <div class="w-full h-4/5 grid">
                    ...
                    <form action="{{ route('jobs.index') }}" method="GET"
                        class="flex w-full h-12 bg-white rounded-[16px]" id="search-bar">
                        <div class="w-full px-4 flex items-center" id="input-search">
                            <input class="w-full focus:border-transparent focus:ring-0 border-0 text-gray-500"
                                type="text" placeholder="Search your dream job..." name="title">
                        </div>

                        <button type="submit"
                            class="flex justify-center items-center w-1/5 bg-[#FF6B2C] rounded-r-2xl cursor-pointer"
                            id="search-button">
