<x-app-layout>
    <div class="py-12 px-10">
        ...
        <div class="flex justify-around">
            <div class="w-fit h-fit bg-gray-100 mr-4 rounded-2xl px-8 py-6" id="filter">
                <div class="font-medium">
                    ...
                    <div class="w-[330px] grid gap-4 text-sm">
                        <div class="w-full h-8 rounded-xl bg-white" id="search-bar"></div>
            ...
            <div class="w-8/12 h-[572px]" id="jobs">
                ...
                <div class="flex justify-between shadow-xl px-7 py-3 mb-4 rounded-xl" id="card">
                    ...
                    <div class="flex flex-col items-end pt-2">
                        ...
                        <div>
                            <a href="/jobs/detail"><button class="w-64 h-[38px] bg-[#055EFF] text-white font-semibold rounded-lg">Apply Now</button></a> 
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-between shadow-xl px-7 py-3 mb-4 rounded-xl" id="card">
                    ...
                    <div class="flex flex-col items-end pt-2">
                        ...
                        <div>
                            <button class="w-64 h-[38px] bg-[#055EFF] text-white font-semibold rounded-lg">Apply Now</button>
                        </div>
                    </div>
                </div>
