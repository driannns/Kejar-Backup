<x-app-layout style="background-color: #F6F7F8">
    <div class=" w-full h-fit py-10" style="background-color: #F6F7F8">
        <form class="w-9/12 mx-auto rounded-lg bg-white shadow-lg p-10" action="/postjob/{{ $job->id }}"
            ...
            <div class="flex mb-6 mt-10">
                <label for="company_name"
                    ...
                    Name</label>
                <input type="text" id="company_name" placeholder="Input your company" name="company_name"
            ...
            <div class="flex mb-6">
                <label for="base-input" class="w-5/12 items-center block mb-2 text-lg font-semibold text-gray-900">Job
                    Name</label>
                <input type="text" id="base-input" placeholder="Input job name" name="job_title"
                    value="{{ $job->job_title }}"
                    class="w-7/12 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
            </div>
            <div class="flex mb-6">
                <label for="category_id" class="w-5/12 block mb-2 text-lg font-semibold text-gray-900">Job
                    Category</label>
            ...
            <div class="flex mb-6">
                ...
                <input type="text" id="base-input" placeholder="Input company location" name="city"
                    value="{{ $job->city }}"
                    class="w-7/12 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
            </div>
            <div class="flex mb-6">
            ...
            <div class="flex mb-6">
                ...
                <select id="experience" name="experience"
                    ...
                    <option value="Fresh Graduate" {{ $job->experience == 'Fresh Graduate' ? 'selected' : '' }}>Fresh
                        Graduate</option>
                </select>
            </div>
            <div class="flex mb-6">
                ...
                <input type="text" id="Salary" placeholder="Input job salary" name="salary"
                    value="{{ $job->salary }}"
                    class="w-7/12 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
            </div>
            <div class="flex mb-6">
            ...
            <div class="mb-6 mt-20">
                <label for="base-input" class=" items-center block mb-2 text-lg font-semibold text-gray-900">Company
                    Background
                    <p class="text-sm text-gray-500 font-normal">A brief description of what your company does (1-2
                        sentences is
                        plenty)</p>
                </label>
                <textarea style="resize:none" id="message" rows="4" name="company_background"
            ...
            <div class="mb-6">
                ...
                <textarea style="resize:none" id="message" rows="4" name="skills"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Write your thoughts here...">{{ $job->skills }}</textarea>
            </div>
            <div class="mb-6">
                <label for="base-input" class=" items-center block mb-2 text-lg font-semibold text-gray-900">Why are
                    you
                    hiring
                </label>
                <textarea style="resize:none" id="message" rows="4" name="whyhiring"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="mb-6">
                ...
                <textarea style="resize:none" id="message" rows="4" name="job_description"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="mb-6">
                ...
                <textarea style="resize:none" id="message" rows="4" name="responsibilities"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
